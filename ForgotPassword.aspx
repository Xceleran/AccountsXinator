<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="Accounts.Xinator.ForgotPassword" %>
                        ...
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 ">
                                <div class="login-container shadow-sm">
                                    <h2>Forgot Password in to XinatorCentral</h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <asp:TextBox ID="txtEmail" class="form-control" runat="server" placeholder="Email"></asp:TextBox><br />
                                        </div>

                                        <div class="col-12 mt-3">
                                            <asp:Button ID="btnSubmit" class="btn btn-primary btn-loginblue w-100" runat="server" Text="Submit" OnClick="btnSubmit_Click" />
                                        </div>
                                    </div>
                                </div>
                            </div>
