...
<body>
 ...
 <input id="payment" type="checkbox" onchange="document.getElementById('btn_Save').disabled = !this.checked;" name="terms" > <span class="redSmall">
     I have read and agree to the terms of the License Agreement.  Click <a href="XSI LICENSE AGREEMENT.htm" target="_blank" class="link-primary">here</a> to read the agreement.</span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>Copyright © 2022 All rights reserved by <a href="" target="_blank">XinatorServco.com</a>
                    </p>
                </div>
            </div>
        </div>
	        ...
	        <div class="container">
	            ...
	            <div class="row">
	                ...
	                <div class="col-12">
	                    ...
	                    <ul class="mb-2">
	                        <li>
	                            Click the "Send Link" button below to open email
	                        </li>
	                        <li>
	                            Enter the email address(es) for the mobile device(s)
	                        </li>
	                        <li>
	                            Send the email
	                        </li>
	                        <li>
	                            Once the user gets the email on the mobile device, they just tap it and are automatically directed to the correct application store for their device. Nice and easy.
	                        </li>
	                    </ul>
	                    
	                    <p class="mt-2">Note: myServiceJOBS+ is an in-app purchase within the JOBS Field App. Just
                                click on "Upgrade to myServiceJOBS+" and you will receive instructions for
                                setting up your Administration and additional field users.</p>
